            ...
            switch (direction) {
                case 'up':
                    ...
                    if (!this.obscured(newLoc)) {
                        this.hasFlag ? this.setStatus("move-up-with-flag") : this.setStatus("move-up");
                        this.clear();
                        this.spawn(newLoc);
                ...
                case 'down':
                    ...
                    if (!this.obscured(newLoc)) {
                        this.hasFlag ? this.setStatus("move-down-with-flag") : this.setStatus("move-down");
                        this.clear();
                        this.spawn(newLoc);
                        this.route.record(newLoc);
                    }
                ...
                case 'left':
                    ...
                    if (!this.obscured(newLoc)) {
                        this.hasFlag ? this.setStatus("move-left-with-flag") : this.setStatus("move-left");
                        this.clear();
                        this.spawn(newLoc);
                        this.route.record(newLoc);
                    }
                ...
                case 'right':
                    ...
                    if (!this.obscured(newLoc)) {
                        this.hasFlag ? this.setStatus("move-right-with-flag") : this.setStatus("move-right");
                        this.clear();
                        this.spawn(newLoc);
                        this.route.record(newLoc);
                    }
